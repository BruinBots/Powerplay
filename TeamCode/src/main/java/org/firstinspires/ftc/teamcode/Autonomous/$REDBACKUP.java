...
public class $REDBACKUP extends LinearOpMode {
...
//                .build();
        ...
        TrajectorySequence forward48 = drive.trajectorySequenceBuilder(trajSeq1.end())
                .forward(48)
                .build();
        ...
        if(isLeft) {
            ...
            if (parkZone == AprilTagRecognitionPipeline.ParkingPosition.RIGHT) {
                strafe = 48;
            } else if (parkZone == AprilTagRecognitionPipeline.ParkingPosition.CENTER) {
                strafe = 24;
            } else {
        ...
        TrajectorySequence strafe24or48 = drive.trajectorySequenceBuilder(forward48.end())
                .strafeRight(strafe)
                .build();
        ...
        drive.followTrajectorySequence(forward48);
        drive.followTrajectorySequence(strafe24or48);
