...
>>>>>>> 3c112b1 (several april tags updates)
...
public class AprilTagRecognitionPipeline extends OpenCvPipeline {
...
//    private volatile SleeveDetection.ParkingPosition position = SleeveDetection.ParkingPosition.LEFT;
    ...
    public int left = 12; // left tag is id12
    public int center = 13; // center tag is id13
    public int right = 14; // right tag is id14
...
<<<<<<< HEAD
    public AprilTagRecognitionPipeline.ParkingPosition getParkingPosition() {
        ArrayList<AprilTagDetection> currentDetections = this.getLatestDetections();
        ParkingPosition position = ParkingPosition.CENTER;
